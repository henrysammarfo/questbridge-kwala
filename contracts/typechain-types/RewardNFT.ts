...
export interface RewardNFT extends BaseContract {
  ...
  hasCustomURI: TypedContractMethod<[tokenId: BigNumberish], [boolean], "view">;
  ...
  mintReward: TypedContractMethod<[to: AddressLike], [bigint], "nonpayable">;
  ...
  setTokenURI: TypedContractMethod<
    [tokenId: BigNumberish, customURI: string],
    [void],
    "nonpayable"
  >;
