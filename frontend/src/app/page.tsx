        ...
        <div className="text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Complete Quests</h3>
              <p className="text-gray-600 dark:text-gray-300">Participate in exciting Web3 challenges and earn rewards</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">Get NFT rewards and tokens for completing quests</p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300">Connect with fellow developers at Kwala Hacker House</p>
            </div>
          </div>
        </div>
      </div>
